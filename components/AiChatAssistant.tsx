...
export const AiChatAssistant: React.FC<AiChatAssistantProps> = ({ isOpen, setIsOpen }) => {
    ...
    const promptStarters = [
        "Siswa mana yang alpha hari ini?",
        "Tampilkan tugas yang belum selesai.",
        "Berapa jumlah total siswa saya?"
    ];
                        ...
                        <div className="flex flex-wrap gap-2 justify-start pl-11">
                            {promptStarters.map(prompt => (
                                <button
                                    ...
                                    className="px-3 py-1.5 bg-gray-200 dark:bg-gray-700/80 text-xs text-gray-700 dark:text-gray-200 rounded-full hover:bg-gray-300 dark:hover:bg-gray-700 transition-colors"
                                >
                                    {prompt}
                                </button>
                            ))}
